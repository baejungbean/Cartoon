...
?>
	...
	<div id="col2">  
		...
		목록 수 : 
		<!--박스생성 ㅋ-->
		<select onchange='location.href=this.value'> <!-- onchange로 값 넘겨줌-->
			<option value='?scale=5' <?if($scale==5) echo"selected";?> >5</option>
			<option value='?scale=10' <?if($scale==10) echo"selected";?> >10</option>
			<option value='?scale=15' <?if($scale==15) echo"selected";?> >15</option>
			<!-- 여기있는 php는 새로고침 됬을때 scale 값을 검사해서 체크박스 기본선택을 하게 함니다-->
		</select>
